...
export const GithubAuthButton = () => {
  ...
  return (
    <button
      ...
      className='bg-white hover:bg-gray-500 text-black py-2 px-4 rounded flex gap-4align-middle items-center justify-center border border-gray-300 transition duration-600 ease-in-out transform'
    >
